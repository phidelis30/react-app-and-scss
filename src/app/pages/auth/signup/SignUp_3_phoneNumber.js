...
import { validateSignUp_3_phoneNumber } from '../../../../validations/validateSignUp';
import NavBarAuth from '../../../components/NavBarAuth';
import SignUpHead from '../../../components/SignUpHead';
import SignUpImg from '../../../components/SignUpImg';

const SignUp_3_phoneNumber = (props) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const resultError = validateSignUp_3_phoneNumber({ phoneNumber });
    ...
    <form className='signup' onSubmit={handleSubmit}>
      ...
      <div>
        ...
        <div className='signup__btn'>
          <Link to='/signup/3/email' className='signup__btn__link'>Use email adress</Link>
...
export default SignUp_3_phoneNumber;